    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/basic" :active="request()->routeIs('basic')">
                        {{ __('Basic Plan') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/premium" :active="request()->routeIs('premium')">
                        {{ __('Premium Plan') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/pro" :active="request()->routeIs('pro')">
                        {{ __('Pro Plan') }}
                    </x-jet-nav-link>
                </div>
            </div>
